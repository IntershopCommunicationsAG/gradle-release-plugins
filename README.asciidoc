...
It requires, that the https://github.com/IntershopCommunicationsAG/scmversion-gradle-plugin[SCM Version Plugin] is applied to the project.
It supports also the https://github.com/IntershopCommunicationsAG/buildinfo-gradle-plugin[Buildinfo Plugin]. These properties
are used for the cofniguration of Gradle Artifactory Plugin.
